...
const comparisonRows: { label: string; free: string; proMonthly: string; proLifetime: string }[] = [
  ...
  { label: "Stack Builder", free: "1 / mês", proMonthly: "PRO (até 10/mês)", proLifetime: "PRO (até 10/mês)" },
  ...
  { label: "Exportação (PDF)", free: "1 / mês", proMonthly: "Premium c/ timeline", proLifetime: "Premium c/ timeline" },
