...
const injectionSites: InjectionSite[] = [
  ...
  },
  {
    ...
    x: 42, y: 52, angle: "90°",
    technique: "Quadrante superior externo do glúteo. Maior volume de tecido adiposo.",
    tips: ["Maior volume de tecido — menos dor", "Ideal para volumes maiores"],
    idealFor: ["GH", "Tirzepatida", "Semaglutida"],
  },
  {
    id: "gluteo-sup-esq", name: "Glúteo Superior Esquerdo", region: "Glúteo", side: "dorsal",
    x: 58, y: 52, angle: "90°",
    technique: "Mesmo procedimento do glúteo direito.",
    tips: ["Alternar com lado direito", "Pode precisar de auxílio"],
