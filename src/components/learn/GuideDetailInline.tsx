...
import { ArrowLeft, Clock, Lock, CheckCircle2, AlertTriangle, Lightbulb, ShieldAlert, ClipboardList, Play } from "lucide-react";
...
export default function GuideDetailInline({ slug }: Props) {
  ...
  return (
    <div className="max-w-3xl mx-auto">
      ...
      {/* Header */}
      <div className="rounded-xl border border-border/30 bg-card p-5 sm:p-6 mb-4">
        ...
        <h1 className="text-lg sm:text-xl font-bold text-foreground mb-2" style={{ fontFamily: "'Space Grotesk', sans-serif" }}>
          {guide.title}
        </h1>
      ...
      {!content ? (
        ...
        <div className="space-y-4">
          ...
          <div className="rounded-xl border border-border/30 bg-card p-5">
            <h3 className="text-sm font-bold text-foreground mb-3">Introdução</h3>
            {content.videoUrl && (
