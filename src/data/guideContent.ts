...
export const guideContents: Record<string, GuideContent> = {
  ...
  "7-erros-fatais": {
    ...
    steps: [
      {
        title: "Erro 1: Comprar de Fontes Não Verificadas",
        content: [
          "Peptídeos de qualidade inferior podem conter impurezas ou dosagens incorretas.",
          "Procure fornecedores com certificados de análise (COA) de terceiros.",
          "Verifique pureza mínima de 98% via HPLC.",
          "Desconfie de preços muito abaixo do mercado.",
        ],
        warning: "Peptídeos adulterados podem conter metais pesados, endotoxinas ou dosagens completamente diferentes do rótulo.",
      },
      {
        title: "Erro 2: Agitar o Frasco ao Reconstituir",
        content: [
          "Agitação vigorosa desnatura as ligações peptídicas.",
          "Pode reduzir a eficácia em até 70%.",
          "CORRETO: Girar suavemente entre os dedos por 30-60 segundos.",
          "Deixar o frasco na geladeira por 30 minutos se não dissolver.",
        ],
      },
      {
        title: "Erro 3: Armazenamento Incorreto",
        content: [
          "Peptídeos liofilizados: temperatura ambiente ou refrigerados.",
          "Peptídeos reconstituídos: OBRIGATÓRIO refrigerar (2-8°C).",
          "Nunca congelar após reconstituição.",
          "Proteger da luz direta (especialmente GHK-Cu e Melanotan).",
          "Descartar após 30 dias da reconstituição.",
        ],
      },
      {
        title: "Erro 4: Pular a Assepsia",
        content: [
          "Infecções no local de injeção são evitáveis.",
          "Sempre limpar o topo do frasco com álcool.",
          "Sempre limpar o local de aplicação.",
          "Nunca reutilizar agulhas.",
        ],
      },
      {
        title: "Erro 5: Dosagem Incorreta",
        content: [
          "Usar a calculadora para determinar a dose exata.",
          "Mais NÃO é melhor — doses excessivas aumentam efeitos colaterais sem benefício adicional.",
          "Iniciar sempre pela dose mais baixa recomendada.",
          "Titulação gradual é essencial (especialmente Tirzepatida, Semaglutida).",
        ],
      },
      {
        title: "Erro 6: Não Fazer Exames de Monitoramento",
        content: [
          "Hemograma, glicose, IGF-1, função hepática e renal são essenciais.",
          "Fazer exames ANTES de iniciar (baseline) e a cada 8-12 semanas.",
          "MK-677 exige monitoramento rigoroso de glicose e insulina.",
          "Ignorar exames pode levar a problemas não detectados.",
        ],
      },
      {
        title: "Erro 7: Ignorar Contraindicações",
        content: [
          "Câncer ativo: NUNCA usar secretagogos de GH.",
          "Gravidez: NENHUM peptídeo é seguro.",
          "Pancreatite: Tirzepatida e Semaglutida são proibidos.",
          "Sempre consultar um médico antes de iniciar qualquer protocolo.",
        ],
      },
    ],
