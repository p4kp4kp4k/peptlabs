...
export const guides: Guide[] = [
  { title: "Como Carregar uma Caneta de Peptídeos: Guia Passo a Passo", description: "Aprenda a reconstituir peptídeos liofilizados, carregar um cartucho estéril e administrar a dose usando uma caneta reutilizável.", category: "Recuperação", date: "05 de março de 2026", isPro: true, tab: "guias" },
  { title: "Preparo de Spray Nasal: Selank & Semax (Fórmula Conforto)", description: "Técnica de diluição mista para spray nasal de Selank/Semax que reduz irritação nasal e mantém a eficácia do peptídeo.", category: "Nootrópicos", date: "09 de março de 2026", isPro: true, tab: "guias" },
  { title: "GHK-Cu: Protocolos Tópicos para Pele e Cabelo", description: "Protocolos detalhados de GHK-Cu tópico para rejuvenescimento facial, crescimento capilar e tratamento de dano solar severo.", category: "Estética", date: "01 de março de 2026", isPro: true, tab: "guias" },
  { title: "Guia HGH por Dose: O que Esperar de 1 a 10 UI Diárias", description: "Guia completo sobre dosagem de HGH — cada faixa de dose (1-2, 2-4, 4-8, 6-10+ UI) serve a um propósito diferente.", category: "Performance", date: "01 de março de 2026", isPro: true, tab: "guias" },
  { title: "Reconstituição de Peptídeos: Guia Completo em 10 Etapas", description: "Passo a passo técnico para reconstituir peptídeos liofilizados com segurança: diluentes, volumes, erros comuns e armazenamento.", category: "Recuperação", date: "15 de março de 2026", isPro: true, tab: "guias" },
  { title: "Guia Completo de Injeção Subcutânea (SubQ) e Rotação de Locais", description: "Técnica detalhada de aplicação subcutânea, mapa corporal de locais, rotação semanal e assepsia para peptídeos injetáveis.", category: "Recuperação", date: "15 de março de 2026", isPro: true, tab: "guias" },
  { title: "Stacking de Peptídeos: Top 10 Combinações Comprovadas", description: "As melhores combinações de peptídeos por objetivo: recuperação, emagrecimento, cognição, longevidade, imunidade e mais.", category: "Performance", date: "15 de março de 2026", isPro: true, tab: "guias" },
  { title: "Segurança, Efeitos Colaterais e Monitoramento Bioquímico", description: "Efeitos colaterais por peptídeo, exames de sangue essenciais, contraindicações absolutas e como monitorar seu ciclo com segurança.", category: "Longevidade", date: "15 de março de 2026", isPro: true, tab: "guias" },
  { title: "Guia de Aplicação por Spray Nasal: Selank, Semax e Oxitocina", description: "Como preparar e aplicar peptídeos nasais para máxima absorção cerebral: técnica, diluente, dosagem e cuidados.", category: "Neuro / Cognitivo", date: "15 de março de 2026", isPro: true, tab: "guias" },
  { title: "O Que São Peptídeos? Guia para Iniciantes", description: "Entenda o que são peptídeos, como funcionam no corpo, a história desde a insulina até os neuropeptídeos modernos e por que são diferentes de esteroides e suplementos convencionais.", category: "Fundamentos", date: "15 de março de 2025", isPro: false, tab: "guias" },
  { title: "7 Erros Fatais com Peptídeos (e Como Evitá-los)", description: "Os erros mais comuns que podem desperdiçar seu dinheiro ou causar problemas de saúde. Aprenda como comprar, misturar, armazenar e injetar peptídeos corretamente.", category: "Segurança", date: "15 de março de 2025", isPro: true, tab: "seguranca" },
  { title: "Equilíbrio Redox 101: A Base dos Peptídeos Mitocondriais", description: "Entenda o equilíbrio redox, como a glicose vira ATP, e por que isso é fundamental antes de usar peptídeos mitocondriais como MOTS-c, SS-31 e NAD+.", category: "Fundamentos", date: "15 de março de 2025", isPro: true, tab: "estudos" },
];
